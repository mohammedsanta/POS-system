...
<body class="bg-gradient-to-br from-green-50 via-white to-green-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-extrabold text-gray-800">Create Owner Account</h1>
            <p class="text-gray-500 text-sm mt-1">Sign up to manage your business</p>
        </div>

        <form method="POST" action="{{ route('owner.signup') }}" class="space-y-5">
            @csrf

            {{-- Usernmae --}}
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Userame</label>
        ...
        <div class="mt-6 text-center text-sm">
            ...
            <a href="{{ route('owner.login') }}" class="text-green-600 hover:underline font-medium">Login</a>
        </div>
    </div>
