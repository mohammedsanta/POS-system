...
Route::post('/owner/logout', [OwnerAuthController::class, 'logout'])
    ->middleware('owner') // only logged-in owners can logout
    ->name('owner.logout');

// === Staff logout ===
Route::post('/staff/logout', [StaffAuthController::class, 'logout'])
    ->middleware('staff') // only logged-in staff can logout
    ->name('staff.logout');
...
// IMEI / Barcode Pages
// ============================
// Route::view('/product-barcodes', 'stuff_admin.ProductsBarcode')->name('products.barcodes');
